...
echo "You thus need to have MySQL server installed on your system.";
# TODO (maybe): check if MySQL is installed.
echo "Depending on your sude timeout, you may now be prompted for your sudo password to effect MySQL processes.";
